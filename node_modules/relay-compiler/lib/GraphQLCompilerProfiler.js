...
function end(traceIdx) {
  ...
  !(trace.ph === 'B') ? process.env.NODE_ENV !== "production" ? require("fbjs/lib/invariant")(false, 'Begin trace phase') : require("fbjs/lib/invariant")(false) : void 0;
  !(stack.pop() === trace) ? process.env.NODE_ENV !== "production" ? require("fbjs/lib/invariant")(false, 'GraphQLCompilerProfiler: The profile trace %s ended before nested traces. ' + 'If it is async, try using Profile.waitFor or Profile.profileWait.', trace.name) : require("fbjs/lib/invariant")(false) : void 0;
