...
function visitRelayMetadata(metadataFn) {
  return function (node) {
    ...
    var argValues = require("./getLiteralArgumentValues")(relayDirective.args);
...
function fragmentMetadata(_ref2) {
  var mask = _ref2.mask,
      plural = _ref2.plural;
  !(plural === undefined || typeof plural === 'boolean') ? process.env.NODE_ENV !== "production" ? require("fbjs/lib/invariant")(false, 'RelayRelayDirectiveTransform: Expected the "plural" argument to @relay ' + 'to be a boolean literal if specified.') : require("fbjs/lib/invariant")(false) : void 0;
  !(mask === undefined || typeof mask === 'boolean') ? process.env.NODE_ENV !== "production" ? require("fbjs/lib/invariant")(false, 'RelayRelayDirectiveTransform: Expected the "mask" argument to @relay ' + 'to be a boolean literal if specified.') : require("fbjs/lib/invariant")(false) : void 0;
  return {
    mask: mask,
    plural: plural
  };
