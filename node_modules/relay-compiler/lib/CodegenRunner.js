...
function () {
  ...
  _proto.getDirtyWriters = function getDirtyWriters(filePaths) {
    ...
    return require("./GraphQLCompilerProfiler").asyncContext('CodegenRunner:getDirtyWriters',
    /*#__PURE__*/
    _asyncToGenerator(function* () {
      ...
      yield Promise.all(Object.keys(_this3.parserConfigs).map(function (parserConfigName) {
        return require("./GraphQLCompilerProfiler").waitFor('Watchman:query',
        /*#__PURE__*/
        _asyncToGenerator(function* () {
  ...
  _proto.write = function write(writerName) {
    ...
    return require("./GraphQLCompilerProfiler").asyncContext('CodegenRunner.write',
    /*#__PURE__*/
    _asyncToGenerator(function* () {
      try {
        ...
        var baseDocuments = require("immutable").Map();
        ...
        if (generatedDirectoriesWatchmanExpression) {
          var relativePaths = yield require("./CodegenWatcher").queryDirectories(_baseDir, generatedDirectoriesWatchmanExpression);
          generatedDirectories = relativePaths.map(function (x) {
            return require("path").join(_baseDir, x);
          });
        ...
        var schema = require("./GraphQLCompilerProfiler").run('getSchema', function () {
          ...
          for (var _iterator2 = outputDirectories.values()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            ...
            try {
              for (var _iterator3 = all[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                ...
                !isGeneratedFile(_filePath2) ? process.env.NODE_ENV !== "production" ? require("fbjs/lib/invariant")(false, 'CodegenRunner: %s returned false for isGeneratedFile, ' + 'but was in generated directory', _filePath2) : require("fbjs/lib/invariant")(false) : void 0;
              }
            } catch (err) {
    ...
    var _watch = _asyncToGenerator(function* (parserName) {
      ...
      function () {
        var _ref4 = _asyncToGenerator(function* (files) {
          !_this6.parsers[parserName] ? process.env.NODE_ENV !== "production" ? require("fbjs/lib/invariant")(false, 'Trying to watch an uncompiled parser config: %s', parserName) : require("fbjs/lib/invariant")(false) : void 0;
