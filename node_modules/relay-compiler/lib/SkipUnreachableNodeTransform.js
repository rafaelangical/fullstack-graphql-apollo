...
function transformNode(context, fragments, node) {
  ...
  while (queue.length) {
    ...
    switch (selection.kind) {
      ...
      default:
        selection.kind;
        !false ? process.env.NODE_ENV !== "production" ? require("fbjs/lib/invariant")(false, 'SkipUnreachableNodeTransform: Unexpected selection kind `%s`.', selection.kind) : require("fbjs/lib/invariant")(false) : void 0;
    }
