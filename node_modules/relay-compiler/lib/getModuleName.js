...
function getModuleName(filePath) {
  ...
  var filename = require("path").basename(filePath, require("path").extname(filePath)); // index.js -> index (when extension has multiple segments)


  filename = filename.replace(/(?:\.\w+)+/, ''); // /path/to/button/index.js -> button

  var moduleName = filename === 'index' ? require("path").basename(require("path").dirname(filePath)) : filename; // Example.ios -> Example
