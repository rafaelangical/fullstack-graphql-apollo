...
function _queryFiles() {
  _queryFiles = _asyncToGenerator(function* (baseDir, expression, filter) {
    return yield require("./GraphQLCompilerProfiler").waitFor('Watchman:query',
    /*#__PURE__*/
    _asyncToGenerator(function* () {
      var client = new (require("./GraphQLWatchmanClient"))(QUERY_RETRIES);
...
function _watch() {
  _watch = _asyncToGenerator(function* (baseDir, expression, callback) {
    return yield require("./GraphQLCompilerProfiler").waitFor('Watchman:subscribe',
    /*#__PURE__*/
    _asyncToGenerator(function* () {
      var client = new (require("./GraphQLWatchmanClient"))();
      var watchResp = yield client.watchProject(baseDir);
