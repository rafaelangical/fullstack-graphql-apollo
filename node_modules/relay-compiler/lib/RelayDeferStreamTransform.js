...
function visitLinkedField(field, state) {
  ...
  var type = require("./GraphQLSchemaUtils").getNullableType(field.type);

  if (!(type instanceof require("graphql").GraphQLList)) {
    throw require("./RelayCompilerError").createUserError("Invalid use of @stream on non-plural field '".concat(field.name, "'"), [streamDirective.loc]);
  }
...
function visitScalarField(field, state) {
  ...
  if (streamDirective != null) {
    throw require("./RelayCompilerError").createUserError("Invalid use of @stream on scalar field '".concat(field.name, "'"), [streamDirective.loc]);
  }
...
function getLiteralStringArgument(directive, argName) {
  ...
  if (typeof value !== 'string') {
    ...
    throw require("./RelayCompilerError").createUserError("Expected the '".concat(argName, "' value to @").concat(directive.name, " to be a string literal."), [(_ref5 = arg === null || arg === void 0 ? void 0 : arg.value.loc) !== null && _ref5 !== void 0 ? _ref5 : directive.loc]);
  }
