...
function () {
  ...
  _proto._getFile = function _getFile(key) {
    if (this._dir == null) {
      ...
      var dir = require("path").join(require("os").tmpdir(), "".concat(this._name, "-").concat(cacheID));
  ...
  _proto.getOrCompute = function getOrCompute(key, compute) {
    ...
    return require("./GraphQLCompilerProfiler").run('RelayCompilerCache.getOrCompute', function () {
