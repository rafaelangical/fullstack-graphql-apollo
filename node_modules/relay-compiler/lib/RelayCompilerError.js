...
function createUserError(message, locations, nodes) {
  ...
  return new (require("graphql").GraphQLError)(messageWithLocations, (_nodes = nodes) !== null && _nodes !== void 0 ? _nodes : []);
}
/**
...
function createNonRecoverableUserError(message, locations, nodes) {
  ...
  var error = new (require("graphql").GraphQLError)(messageWithLocations, (_nodes2 = nodes) !== null && _nodes2 !== void 0 ? _nodes2 : []);
...
function createCompilerError(message, locations, nodes) {
  ...
  var error = new (require("graphql").GraphQLError)("Internal Error: ".concat(messageWithLocations), (_nodes3 = nodes) !== null && _nodes3 !== void 0 ? _nodes3 : []);
  return new Error(error.message);
}
/**
  ...
  try {
    for (var _iterator = iterable[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      try {
        ...
        if (error instanceof require("graphql").GraphQLError) {
          errors.push(error);
        } else {
          throw error;
        }
