...
function getFragmentScope(definitions, args, parentScope, spread) {
  ...
  var errors = require("./RelayCompilerError").eachWithErrors(definitions, function (definition) {
    if (definition.kind === 'RootArgumentDefinition') {
      if (argMap.has(definition.name)) {
        ...
        throw require("./RelayCompilerError").createUserError("Unexpected argument '".concat(definition.name, "' supplied to fragment '").concat(spread.name, "'. @arguments may only be provided for variables defined in the fragment's @argumentDefinitions."), [(_ref = argNode === null || argNode === void 0 ? void 0 : argNode.loc) !== null && _ref !== void 0 ? _ref : spread.loc]);
      }
      ...
      if (arg == null || arg.kind === 'Literal' && arg.value == null) {
        ...
        // value.
        if (definition.defaultValue == null && definition.type instanceof require("graphql").GraphQLNonNull) {
          var _ref2;
          ...
          throw require("./RelayCompilerError").createUserError("No value found for required argument '".concat(definition.name, ": ").concat(String(definition.type), "' on fragment '").concat(spread.name, "'."), [(_ref2 = _argNode === null || _argNode === void 0 ? void 0 : _argNode.loc) !== null && _ref2 !== void 0 ? _ref2 : spread.loc]);
        }
