...
function transform(context, visitor, stateInitializer) {
  ...
  return context.withMutations(function (ctx) {
    ...
    var errors = require("./RelayCompilerError").eachWithErrors(context.documents(), function (prevNode) {
      var nextNode;
...
function () {
  ...
  _proto._traverse = function _traverse(prevNode) {
    ...
    switch (prevNode.kind) {
      ...
      default:
        prevNode;
        !false ? process.env.NODE_ENV !== "production" ? require("fbjs/lib/invariant")(false, 'GraphQLIRTransformer: Unknown kind `%s`.', prevNode.kind) : require("fbjs/lib/invariant")(false) : void 0;
    }
  ...
  _proto._traverseChildren = function _traverseChildren(prevNode, pluralKeys, singularKeys) {
    ...
    pluralKeys && pluralKeys.forEach(function (key) {
      ...
      !Array.isArray(prevItems) ? process.env.NODE_ENV !== "production" ? require("fbjs/lib/invariant")(false, 'GraphQLIRTransformer: Expected data for `%s` to be an array, got `%s`.', key, prevItems) : require("fbjs/lib/invariant")(false) : void 0;
  ...
  _proto._getState = function _getState() {
    !this._states.length ? process.env.NODE_ENV !== "production" ? require("fbjs/lib/invariant")(false, 'GraphQLIRTransformer: Expected a current state to be set but found none. ' + 'This is usually the result of mismatched number of pushState()/popState() ' + 'calls.') : require("fbjs/lib/invariant")(false) : void 0;
