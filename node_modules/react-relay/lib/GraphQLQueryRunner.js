...
function () {
  ...
  var _proto = GraphQLQueryRunner.prototype;

  _proto.run = function run(querySet, callback) {
...
function splitAndFlattenQueries(storeData, queries) {
  ...
  queries.forEach(function (query) {
    return flattenedQueries.push.apply(flattenedQueries, (0, _toConsumableArray2["default"])(require("./flattenSplitRelayQueries")(require("./splitDeferredRelayQueries")(query))));
  });
  ...
  require("./throwFailedPromise")(storeData.getTaskQueue().enqueue(function () {
    ...
    if (fetchMode === require("./RelayFetchMode").CLIENT) {
      require("fbjs/lib/forEachObject")(querySet, function (query) {
        if (query) {
          queries.push.apply(queries, (0, _toConsumableArray2["default"])(require("./diffRelayQuery")(query, storeData.getRecordStore(), storeData.getQueryTracker())));
        }
      });
    } else {
      require("fbjs/lib/forEachObject")(querySet, function (query) {
