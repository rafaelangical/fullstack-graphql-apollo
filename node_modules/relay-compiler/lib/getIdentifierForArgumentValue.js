...
function getIdentifierForArgumentValue(value) {
  switch (value.kind) {
    ...
    default:
      !false ? process.env.NODE_ENV !== "production" ? require("fbjs/lib/invariant")(false, 'getIdentifierForArgumentValue(): Unsupported AST kind `%s`.', value.kind) : require("fbjs/lib/invariant")(false) : void 0;
  }
}
